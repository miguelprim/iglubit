...
features:
  ...
  - icon: "las la-shield-alt"
    title: "CV"
    content: "We optimize your CV"
  - icon: "las la-magnet"
    title: "Client focus"
    content: "We advise you to achieve a successful interview"
  - icon: "las la-tachometer-alt"
    title: "Timing"
    content: "According the time frame required to you for a smooth moving to Germany"
  - icon: "las la-search"
    title: "Motivation"
    content: "Figuring out the domain fields of your professional interest"
  - icon: "las la-box"
    title: "Qualification"
    content: "Examining the best career path for you"
  - icon: "las la-code"
    title: "Innovation"
    content: "Suggesting the latest Skills which can provide you the ability to step in"
